...
/* Write the calander to the element with the id "calender" */
...
function daysInMonth(calDate){
    ...
    //Retyrn the number of days for the current month
    return dayCount[thisMonth];
}

/*Function to write table rows for each day of the month*/
function calDays(calDate){
    // Datermine the starting day of the month
    var day = new Date(calDate.getFullYear(), calDate.getMonth(), 1);
    var weekDay = day.getDay();

    // Write black cells preceding the starting day
    var htmlCode = "<tr>";
